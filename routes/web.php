...
Route::get('MyPhoto/{id}/{name}','PhotoController@show');
Route::get('MyAlbum/{id}/{name}','AlbumController@show');
Route::get('Manage','AdminController@manageUsers')->name('Manage');
Route::get('Manage_Photo','AdminController@managePhotos');
...
Route::get('DeleteImage/{id}','PhotoController@destroy');
