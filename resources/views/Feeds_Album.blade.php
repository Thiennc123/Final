 	...
 	<div class="row mt-3 justify-content-between">
		@foreach($listImg as $Album)
					  ...
					  <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
					  	<a data-toggle="modal" data-target="#{{$Album->id}}" href="">
					  	<div class="card mb-3 " style="margin: auto;">
						  <div class="row no-gutters">
						    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 card-img img-responsive thien"  id="cart_img">
						    	<img src="{{ asset('image/' . $Album->link) }}" style="width: 100%; height: 100%;">
					      
					    </div>
						    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" style="background-color: #F0EFEF">
...
<div class="modal fade" id="{{$Album->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="carousel-inner">
      ...
      $a = 0;
	@endphp
	    @foreach($listImg as $linkImg)
	    	@foreach($linkImg->photos()->get() as $photo)
				<div class="carousel-item {{ ($a == 0) ? 'active' : ''  }}">
	      		<img class="d-block w-100" src="{{ asset('image/' . $photo->link) }}" alt="First slide">
	    		</div>
	    		@php
					$a++;
	    		@endphp
