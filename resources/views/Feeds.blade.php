...
@section('main_content')
				<div class="row">
			  		...
			  		<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
						  ...
						  <button type="button" class="btn btn-secondary"><a href="{{url('Feeds_Photo')}}">Photo</a></button>
						  <button type="button" class="btn btn-secondary"><a href="{{url('Feeds_Album')}}">Album</a></button>
						</div>
